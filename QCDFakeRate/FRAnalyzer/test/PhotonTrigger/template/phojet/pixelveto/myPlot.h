...
for(int j=0;j<9;j++){
  ...
  TString main_path = "/pnfs/cms/WAX/11/store/user/sushil/MonoPhoton/QCDFakeRate_PhotonTrigger/PhotonJet/";  //<<-----Change the in input File path
  TString main_short_path ="/pnfs/fnal.gov/usr/cms/WAX/11/store/user/sushil/MonoPhoton/QCDFakeRate_PhotonTrigger/PhotonJet/";
